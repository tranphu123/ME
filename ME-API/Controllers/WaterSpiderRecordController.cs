...
namespace ME_API.Controllers
{
    ...
    public class WaterSpiderRecordController : ControllerBase
    {
        ...
        public WaterSpiderRecordController(IWaterSpiderRecordService waterSpiderRecordService,IAuditPicDService auditPicDService,
        ...
        [HttpGet("getaudittypebybrandbywaterspider")]
        public async Task<IActionResult> GetListAuditTypeByBrandByWaterSpider(string brand)
        {
