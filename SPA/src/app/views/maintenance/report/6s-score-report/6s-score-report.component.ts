...
import { SixsScoreReportService } from "../../../../_core/_services/sixs-score-report.service";

@Component({
  selector: "app-6s-score-report",
  templateUrl: "./6s-score-report.component.html",
  styleUrls: ["./6s-score-report.component.scss"]
})
export class SixsScoreReportComponent implements OnInit {
  ...
  constructor(
    private scoreRecordService: SixsScoreReportService,
  ...
  getListLine() {
    ...
    this.mesOrgService.getAllLineIdAuditOrg(pdc, building, is6S).subscribe(res => {
