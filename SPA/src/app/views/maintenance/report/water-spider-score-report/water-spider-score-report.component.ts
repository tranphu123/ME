...
import { WaterSpiderScoreReportService } from '../../../../_core/_services/water-spider-score-report.service';

@Component({
  selector: 'app-water-spider-score-report',
  templateUrl: './water-spider-score-report.component.html',
  styleUrls: ['./water-spider-score-report.component.scss']
})
export class WaterSpiderScoreReportComponent implements OnInit {
